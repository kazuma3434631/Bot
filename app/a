...
# botのアクセストークン
TOKEN = os.getenv("MTQyMTM2NTA3NTQ5OTAyNDQ0NA.GFBiMq.Zh6zy6JCmwpB7VwzZcqoiOiNXiJ9EYDQ5pRFvY")                              # Discord botのトークンを環境変数から取得
DIFY_KEY = os.getenv("MTQyMTM2NTA3NTQ5OTAyNDQ0NA.GFBiMq.Zh6zy6JCmwpB7VwzZcqoiOiNXiJ9EYDQ5pRFvY")                    # DIFY APIのキーを環境変数から取得
